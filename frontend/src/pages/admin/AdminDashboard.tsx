...
export default function AdminDashboard() {
  ...
  const metrics = data
    ? [
        ...
        { label: 'Активных подписок', value: formatNum(data.active_subscriptions) },
        { label: 'Premium', value: formatNum(data.premium_users) },
        { label: 'Платящих', value: formatNum(data.paying_users) },
        { label: 'Доход (⭐)', value: formatNum(data.total_revenue_stars) },
        { label: 'ARPU', value: formatNum(data.arpu) },
