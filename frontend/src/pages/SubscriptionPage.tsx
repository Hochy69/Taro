    ...
    try {
      ...
      if (result === 'paid' || result === 'free') {
        ...
        const successText: Record<string, string> = {
          ...
          compatibility: '✅ Совместимость доступна на главном экране.',
    ...
    <div className="page-shell pb-12">
      ...
      >
        ...
        <GlassCard className="text-center border-tarot-gold/30 py-5">
          ...
          <p className="text-white/60 text-sm mt-1">15 раскладов в сутки • Вся история • Совместимость бесплатно</p>
