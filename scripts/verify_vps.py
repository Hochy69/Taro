...
cmds = [
    ...
    "curl -s -o /dev/null -w 'smartape:%{http_code}\\n' https://s1715822.smartape-vps.com/",
    "cd /opt/taro && git log -1 --oneline",
    "grep TELEGRAM_WEBAPP /opt/taro/.env",
    "grep -n 'border-pink-400' /opt/taro/frontend/src/pages/WelcomePage.tsx | head -1",
    "grep -n 'border-pink-400' /opt/taro/frontend/src/pages/ReturningPage.tsx | head -1",
